...
func handleRequest(ctx context.Context, lambdaMessage LambdaMessage) (string, error) {
	path := "/wp-json/wc-tespo/v1/reward-dispenser-connection?consumer_key=" + os.Getenv("CONSUMER_KEY") + "&consumer_secret=" + os.Getenv("CONSUMER_SECRET") + "&account_id=" + lambdaMessage.Payload.Customer.ID
